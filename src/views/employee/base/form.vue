      ...
      >
        ...
        <el-form-item label="所属部门" size="small" prop="deptId">
          <treeselect
            ...
            :options="depts"
            :style="style"
            @select="deptSelectChange"
            :disabled="mask"
          />
        </el-form-item>


        <el-form-item label="所属岗位" size="small" prop="jobId">
          <el-select v-model="form.jobId" placeholder="岗位" :disabled="mask">
        ...
        <el-form-item label="移动电话" prop="mobilePhone" size="small" label-width="auto">
          <el-input placeholder="移动电话" v-model="form.mobilePhone" :disabled="mask"></el-input>
        </el-form-item>
