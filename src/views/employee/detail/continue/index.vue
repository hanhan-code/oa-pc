  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-upload
        ...
        :action="$network + '/emp/continue/batch'"
        :limit="1"
        :file-list="fileList"
    ...
    <div class="content-container">
      ...
      <div class="content" style="margin-top: 10px;">
        ...
        >
          ...
          <el-table-column prop="compulsoryHour" label="必修学时"></el-table-column>
...
<script>
  ...
  import { batchDel, page, exportExcel } from '@/api/employee/continueEducation'
  ...
  export default {
    ...
    mounted() {
      ...
      this.getDictMap('em_learn_form,em_register_major')
    },
    methods: {
