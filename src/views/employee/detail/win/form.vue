  ...
  >
    ...
    >
      ...
      >
        ...
        <el-form-item label="获奖名称" prop="prizeName" size="small">
          <el-input placeholder="获奖名称" v-model="form.prizeName" :disabled="mask"></el-input>
        </el-form-item>
        ...
        <el-form-item label="发证机关/授予单位" prop="grantUnit" size="small">
          <el-input placeholder="发证机关/授予单位" v-model="form.grantUnit" :disabled="mask"></el-input>
        </el-form-item>

        <el-form-item label="获奖等级" size="small" prop="winLevel">
          <el-select v-model="form.winLevel" placeholder="获奖等级" :disabled="mask">
            <el-option
        ...
        <el-form-item label="是否有原件" prop="origin" size="small">
