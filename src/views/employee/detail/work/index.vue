    ...
    <div class="content-container">
      ...
      <div class="content" style="margin-top: 10px;">
        ...
        >
          ...
          <el-table-column prop="workUnit" :show-overflow-tooltip="true" label="工作单位"></el-table-column>
...
import { batchDel, page, exportExcel } from '@/api/employee/workExperience'
import { downTemplate } from '@/api/employee/employee'
import Form from './form'
import { getToken } from '@/utils/auth'

export default {
  name: 'work-experience',      // 工作经历
  props: {
