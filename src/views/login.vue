    ...
    <el-container>
      ...
      <el-main>
        ...
        <div class="login-phone" v-show="loginPhone">
          <el-form ref="phoneForm" :model="phoneForm" label-position="left" label-width="0px" :rules="rules">
            <h3>手机号码登录</h3>
            <el-form-item prop="phone">
              <el-input placeholder="请输入手机号码" v-model="phoneForm.phone"  type="phone" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" maxlength="11"> </el-input>
            </el-form-item>
            <el-form-item prop="code">
              <el-input placeholder="请输入手机验证码" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" v-model="phoneForm.code"  type="text" style="width: 60%;" maxlength="6">
              </el-input>
              <el-button type="text" class="Verification" :class="{disabled: !this.canClick}" @click="sendVerificationCode(phoneForm.phone)"
                style="width: 34%;">{{contentCode}}</el-button>
            </el-form-item>
            <!-- <el-form-item style="width:100%;height: 30px;">
            ...
            <el-form-item style="width:100%;">
              ...
              <el-button :loading="loading" size="medium" type="primary" style="width:100%;" @click.native.prevent="handleCode">
                <span v-if="!loading">登 录</span>
                <span v-else>登 录 中...</span>
              </el-button>
            </el-form-item>
      ...
      <el-footer>
        <ul>
          ...
          <li>用户手册</li>
          <el-divider direction="vertical"></el-divider>
          <li><a href="http://beian.miit.gov.cn/" target="_blank">{{ $store.state.settings.caseNumber }}</a></li>
        </ul>
      </el-footer>
    </el-container>
  </div>
    ...
    methods: {
      ...
      handleCode() {
        ...
        this.$refs.phoneForm.validate(res => {
          ...
          if (res) {
            this.loading = true,
              this.$store.dispatch('CodeIN', phoneLogin).then(() => {
                this.loading = false
