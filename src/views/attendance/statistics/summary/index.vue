  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-row type="flex" class="row-bg" justify="space-between">
        <el-col :span="23">
          ...
          <!-- 员工选择 -->
          <el-input size="small" style="width:16%; margin-left: 20px" placeholder="选择人员" v-model="choseUser" disabled
    ...
    <div class="content-container" style="margin-top: 10px">
      ...
      <el-table size="small" row-key="index" :data="pageData.data" style="width: 100%;" border>
        ...
        <!-- 手动控制列 -->
        <el-table-column v-if="columns.selects.indexOf(columns.cls[0]) > -1" prop="attendance" :label="columns.cls[0]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[1]) > -1" prop="rest" :label="columns.cls[1]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[2]) > -1" prop="late" :label="columns.cls[2]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[3]) > -1" prop="lateMin" :label="columns.cls[3]">
          <template slot-scope="scope">
            <span>{{scope.row.lateMin | secondFormat}}</span>
          </template>
        </el-table-column>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[4]) > -1" prop="seriousLate"
                         :label="columns.cls[4]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[5]) > -1" prop="seriousLateMin"
                         :label="columns.cls[5]">
          <template slot-scope="scope">
        ...
        <el-table-column v-if="columns.selects.indexOf(columns.cls[6]) > -1" prop="leaveEarly" :label="columns.cls[6]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[7]) > -1" prop="leaveEarlyMin"
                         :label="columns.cls[7]">
          <template slot-scope="scope">
        ...
        <el-table-column v-if="columns.selects.indexOf(columns.cls[8]) > -1" prop="absenteeism"
                         :label="columns.cls[8]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[9]) > -1" prop="missCard" :label="columns.cls[9]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[10]) > -1" prop="workHour"
        ...
        <el-table-column v-if="columns.selects.indexOf(columns.cls[11]) > -1" prop="patchCard"
                         :label="columns.cls[11]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[12]) > -1" prop="leave"
                         :label="columns.cls[12]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[13]) > -1" prop="goOut"
                         :label="columns.cls[13]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[14]) > -1" prop="businessTrip"
                         :label="columns.cls[14]"/>

        <el-table-column v-if="columns.selects.indexOf(columns.cls[15]) > -1" prop="overtime"
                         :label="columns.cls[15]"/>

        <!-- 动态显示列 -->
        <el-table-column v-for="(item, index) in columns.dynamic" :prop="item.prop" :key="index"
                         :label="item.label"/>
      </el-table>
    </div>
