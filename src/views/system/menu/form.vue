  ...
  <el-dialog :visible.sync="dialog" :title="isAdd ? '新增菜单' : '编辑菜单'" append-to-body width="600px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="内部菜单" prop="iframe">
        <el-radio v-model="form.iframe" @change="changeTest"  label="1">是</el-radio>
        <el-radio v-model="form.iframe" @change="changeTest"  label="0" >否</el-radio>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      form: { name: '', sort: 999, path: '', component: '', iframe: '1', roles: [], pid: 0, icon: '' },
      rules: {
        name: [
